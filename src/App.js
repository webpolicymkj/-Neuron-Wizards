          ...
          <div className="container header-container">
            <div className="header-left">
              <div className="logo-wrapper">
                <img src={logoImg} alt="Neuron Wizards" className="logo-img" />
                <span className="studio-name">Neuron Wizards</span>
              </div>
            </div>
      ...
      <section id="about" className="section about">
        <div className="container about-row">
          <div className="about-text-container">
            <h2 className="highlight-title">Neuron Wizards – Welcome Aboard</h2>
            <p className="about-text">Neuron Wizards is a forward-thinking mobile app studio committed to crafting innovative, dependable, and easy-to-use applications. Our mission is to blend creativity with functionality, delivering solutions that span across casual gaming, productivity, lifestyle, and education. Each app we develop is carefully designed with user experience in mind — offering intuitive navigation, thoughtful details, and practical value — to make everyday life simpler, smarter, and more enjoyable for users around the globe.
            </p>
          </div>
      ...
      <section id="contact" className="section contact">
        <div className="container text-center">
          ...
          <p>
            ...
            <a href="mailto: blakeclark0127@gmail.com"> blakeclark0127@gmail.com</a><br />
    ...
    <Router>
      <div className="App">
        ...
        <footer className="footer">
          <div className="container text-center">
            <p>&copy; {new Date().getFullYear()} Neuron Wizards. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </Router>
